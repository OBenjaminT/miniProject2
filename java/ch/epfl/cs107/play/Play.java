...
public class Play {
	...
	public static void main(String[] args) throws Exception {
		...
		// I changed window to implement Autoclosable, so we just do a try-with-resources and it closes it automatically
		try (final Window window = new SwingWindow(game.getTitle(), fileSystem, WINDOW_WIDTH, WINDOW_HEIGHT)) {
