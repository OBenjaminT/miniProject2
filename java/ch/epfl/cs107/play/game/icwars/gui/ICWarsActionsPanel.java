...
public class ICWarsActionsPanel implements Graphics {
    ...
    public void draw(Canvas canvas) {
        ...
        final Transform transform = Transform.I
            .translated(canvas.getPosition().add(width / 4, height / 4));
        background.setRelativeTransform(transform);
        background.draw(canvas);

        final Transform textTransform = Transform.I
            .translated(canvas.getPosition().add(width / 4 + .1f, height / 2));
